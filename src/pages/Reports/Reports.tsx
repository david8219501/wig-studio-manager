    ...
    return {
      summaryStats: [
        ...
        },
        {
          ...
          tooltip: "הכנסה גולמית שנתית (סך מחירי ההזמנות) פחות כל ההוצאות השנתיות שנרשמו, כולל רכישות מלאי - לא מבוסס על עלות ייצור בפועל לכל הזמנה (שונה מ'רווח החודש' בדשבורד).",
        },
      ],
      monthlyRows,
      profitByTypeMonthly,
